...
import LaundryServiceLayout from "./services/LaundryServiceLayout"
import CleaningServiceLayout from "./services/CleaningServiceLayout"
...
function AppBody() {
  ...
  useEffect(() => {
    ...
    boxes.forEach(box => {
      const anim = gsap.from(box, { y: 300, opacity: 0, paused: true });
  ...
  return (
    ...
    <div className=' h-full  overflow-x-scroll scrollbar-hide scroll-m-0'>
      ...
      <div className=" px-5 md:px-10 lg:px-60   box" > <WhyUS /></div>
      <div className="box px-5 md:px-10 lg:px-60 pt-20 lg:pt-0" id='LaundryServiceLayout'>
      ...
      <div className=" bg-opacity-5 px-5 md:px-10 lg:px-60  "><Testimonials /></div>

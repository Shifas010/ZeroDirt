export const CleaningCartDetails = [
    {
...
export const LaundryCartDetails =[
    {
        ...
        herdersize: "Xl",
        discription: "Get expert washing and ironing in Nilambur, Malappuram, Keralam! We clean, freshen, and press your clothes to perfection, ensuring a crisp, wrinkle-free look effortlessly.",
        bold: false,
        textsize: "text-lg font-light",
        imageUrl:"/images/laudry.png"
    }
    , {
        Header: "wash & Fold",
        herdersize: "Xl",
        discription: "Experience hassle-free laundry with our wash and folding service in Nilambur, Malappuram, Keralam. We wash, neatly fold, and deliver fresh, organized clothes with care!",
        ...
        discription: "Experience premium laundry in Nilambur, Malappuram, Keralam! We use high-end detergents and expert care to ensure your clothes stay fresh, pristine, and luxuriously clean.",
